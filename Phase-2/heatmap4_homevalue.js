...
(function() {
    ...
    // Cell value = average home market value in dollars
    // Displayed as: '$' + Math.round(d.value / 1000) + 'K'  →  e.g. 95395 → "$95K"
    ...
    window.heatmapBus.register(
        ...
        cells,
        sampleData,
        d => '$' + Math.round(d.value / 1000) + 'K'
    );
    window.heatmapBus.registries['homevalue'].label = '🏡 Avg Home Value';
